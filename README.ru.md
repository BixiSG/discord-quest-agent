...
браузере) и **Сообщить о проблеме** (открывает issues). Список изменений только на
английском.
...
1. Скачайте [последний релиз](../../releases/latest) (v1.3.0 или новее) или *Code -> Download ZIP*.
